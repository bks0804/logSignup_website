...
const SigninPass = () => {
  ...
  // Get email from the first page via location.state
  ...
  const handleSubmit = (e) => {
    ...
    // Navigate to a dashboard or success page
  };
            ...
            <div>
              <div className="mt-1">
                <input
                  ...
                  required
                  placeholder=""
                  className="block w-full rounded-md border-none bg-slate-50   px-2 py-2 outline-none text-black   placeholder:text-gray-400  sm:text-sm sm:leading-6"
                />
              </div>
            </div>
            <div>
              <div className="mt-1 relative">
                ...
                <span>
                  <span
                    className="flex justify-end items-end bottom-2 left-7 relative left-12%"
